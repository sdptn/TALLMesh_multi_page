...
from llm_utils import llm_call, default_models, blablador_models, graphia_llm_models
import logging
import tooltips
import time
...
def main():
    ...
    if selected_project != "Select a project...":
        ...
        graphia_options = [f"graphia-llm:{m}" for m in graphia_llm_models]
        model_options = default_models + azure_models + blablador_models + graphia_options
